...
def prepare_lexicon(lexicon, silence_phones, nonsilence_phones, optional_silence, oov, dir: Path):
...
nonsilence_phones = sorted(
    ['L', 'S', 'Z', 'a', 'b', 'd', 'dZ', 'dzp', 'e', 'f', 'g', 'i', 'j', 'k', 'l', 'm', 'n', 'nj', 'o', 'p', 'r', 's',
     't', 'tS', 'tcp', 'ts', 'u', 'v', 'x', 'z'])
...
def words_to_lexicon(wordlist: List, model: Path, dir: Path):
    ...
    psyms, wsyms, L = prepare_lexicon(lexicon, silence_phones, nonsilence_phones, optional_silence, oov, dir)
